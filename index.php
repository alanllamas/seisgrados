...
<body  ng-controller="MainCtrl as main" ng-app="myApp">
			...
			<div class="loader">
				...
				<img class="hidden-xs hidden-sm" src="img/loader-128.gif" alt="">
				<img class="visible-sm visible-xs" src="img/loader-256.gif" alt="">
			</div>
	...
	<script src="public/lib/angular-wizard/dist/angular-wizard.min.js" ></script>
